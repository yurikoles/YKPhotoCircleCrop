//
//  YKCircleCropViewController.swift
//
//  Created by Keke Arif on 29.02.2016.
//  Modified by Andrea Antonioni on 14.01.2017.
//  Modified by Yurii Kolesnykov on 02.06.2018.
//  Copyright © 2017 Yurii Kolesnykov. All rights reserved.
//

import UIKit

@objc public protocol YKCircleCropViewControllerDelegate: class {
...
open class YKCircleCropViewController: UIViewController, UIScrollViewDelegate {
    ...
    open weak var delegate: YKCircleCropViewControllerDelegate?
    /// Image to crop
    ...
    fileprivate var scrollView: YKCircleCropScrollView!
    fileprivate var cutterView: YKCircleCropCutterView!
    ...
    fileprivate func setupCutterView() {
        cutterView = YKCircleCropCutterView()
